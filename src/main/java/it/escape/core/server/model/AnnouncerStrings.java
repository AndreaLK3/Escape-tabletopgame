...
public class AnnouncerStrings extends Observable implements Announcer {
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announcePlayerDisconnected(it.escape.core.server.controller.game.actions.PlayerActionInterface)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announceAttack(it.escape.core.server.controller.game.actions.PlayerActionInterface, it.escape.core.server.model.game.gamemap.positioning.PositionCubic)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announceNoise(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announceObjectCard(it.escape.core.server.controller.game.actions.PlayerActionInterface, it.escape.core.server.model.game.cards.ObjectCard)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announceDeath(it.escape.core.server.controller.game.actions.PlayerActionInterface)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announceDefense(it.escape.core.server.model.game.gamemap.positioning.PositionCubic)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announcePlayerPosition(it.escape.core.server.controller.game.actions.PlayerActionInterface, it.escape.core.server.model.game.gamemap.positioning.PositionCubic)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announceEscape(it.escape.core.server.controller.game.actions.PlayerActionInterface)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announceGameEnd()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announceEndOfResults()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announceTeamVictory(it.escape.core.server.model.game.players.PlayerTeams, java.util.List)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announceTeamDefeat(it.escape.core.server.model.game.players.PlayerTeams)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announcePlayerRename(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announceChatMessage(it.escape.core.server.controller.game.actions.PlayerActionInterface, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.escape.core.server.model.Announcer#announceGameStartETA(int)
	 */
	@Override
